							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" >
										...
										<a class="dropdown-item" href="../../lending.php">Lending/Payments</a>
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" >
										...
										<a class="dropdown-item" href="https://cuacg.com/" target="_blank">CU Audit & Compliance Group</a>
										...
										<a class="dropdown-item" href="https://thesalusgroup.com/leveragebenefitsgroup/" target="_blank"><em>LEVERAGE</em> Benefits Group</a>
										...
										<a class="dropdown-item" href="https://www.trutreasury.com/" target="_blank">Tru Treasury</a>
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" >
										...
										<a class="dropdown-item" href="https://pardot.lscu.coop/l/513811/2020-08-03/3s98qdw" target="_blank">Sign up for the News</a>
										<a class="dropdown-item" href="http://www.southeasterncunews.com/" target="_blank">Southeastern CU News</a>
										<a class="dropdown-item" href="https://lscu.coop/about/opportunities.php" target="_blank">Ads/Sponsorships</a>
